...
Planet[] planets = { new Planet(10,     5,   #FF8103,   new PVector(300, 300),   new PVector(10,   -3),     new PVector(0, 0)),
                     new Planet(500,    30,  #0EFF03,   new PVector(400, 400),   new PVector(-10,  -1),     new PVector(0, 0)),
                     new Planet(9000,   10,  #000000,   new PVector(250, 250),   new PVector(-0,    0),     new PVector(0, 0))  };
